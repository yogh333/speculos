...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run one or more QEMU instances given the config files passed as arguments. The -c/--config argument can be passed several times (please note that the arguments order matters.)"
    )
